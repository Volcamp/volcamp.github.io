...
<section class="section-speaker section">
    <div class="container">
        <div class="row section-heading">
            <div class="col-lg-6">
                <div class="heading">
                    <div class="pl-90"><span class="stroke-text">Comment venir</span>
                        <h2>en terre volcanique</h2>
                    </div>
                </div>
            </div>
        </div>
