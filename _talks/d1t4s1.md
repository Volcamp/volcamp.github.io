...
Effets secondaires connus : addiction aux commits propres, refus catégorique de merger sans rebase, et tendance à évangéliser vos collègues sur git worktree.  Prérequis : savoir ce qu'est un commit (si vous tapez encore git add . les yeux fermés en priant, c'est parfait, on est là pour ça).